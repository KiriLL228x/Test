...
while(n_queastion <= n)
  {
    if(PAGE=="Начало")
    {
        ...
        txDrawText(550,100,750,150, "НАЧАТЬ");
...
//рисвоание ответов после if
    ...
    sprintf(s, "Вопрос № %d из %d", n_queastion, n);
  ...
  if(click(550))
    ...
    sprintf(s, "ВАШ РЕЗУЛЬТАТ - %d Из 10\n"
    "Если ваш результат меньше 5 то у вас мало шансов выжить, если больше то и шнасов больше!", point);
    txSetColor(TX_WHITE);
    txSetFillColor(TX_BLACK);
